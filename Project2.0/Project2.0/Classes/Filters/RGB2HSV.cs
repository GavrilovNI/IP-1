...
{
    public class RGB2HSV : OpenCVFilter
    {
        protected override RequiredColorType requiredInputColorType => RequiredColorType.ColorRGB;

        protected override RequiredColorType requiredOutputColorType => RequiredColorType.ColorHSV;

        public override Mat Run(Mat mat)
        {
            return mat.CvtColor(ColorConversionCodes.RGB2HSV);
        }
    }
}
